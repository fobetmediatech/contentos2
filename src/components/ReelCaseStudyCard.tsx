...
export function ReelCaseStudyCard({
  ...
  if (status === 'pending' || status === 'analyzing') {
    return (
      <div className="flex items-center gap-2.5 px-4 py-3 rounded-xl bg-surface border border-[rgba(245,237,214,0.08)] text-sm">
  ...
  if (status === 'skipped') {
    return (
      <div className="px-4 py-3 rounded-xl bg-surface border border-[rgba(245,237,214,0.08)] text-sm text-muted">
        No video to analyze.
      </div>
    )
  }
  ...
  if (status === 'done' && result) {
    return (
      <div className="flex flex-col gap-3 min-w-0">
        ...
        <div className="px-4 py-3 rounded-xl bg-surface border border-[rgba(245,237,214,0.08)]">
          ...
          <div className="flex flex-wrap gap-x-4 gap-y-1 mt-3 pt-3 border-t border-[rgba(245,237,214,0.08)] font-mono text-xs text-muted tabular-nums">
